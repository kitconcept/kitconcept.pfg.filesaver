...
#
#  $ bin/test -s kitconcept.pfg.filesaver -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src kitconcept.pfg.filesaver.testing.KITCONCEPT_PFG_FILESAVER_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/kitconcept/pfg/filesaver/tests/robot/test_example.robot
#
